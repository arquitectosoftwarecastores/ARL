...
// *********************************************************************************************************************
  ...
  header("Content-Disposition: attachment; filename=historico_de_posiciones.csv");
...
<?php  
   echo "Fecha-hora;Posición;Velocidad;Distancia;Ignición;Odómetro;Comb.Total;Latitud;Longitud\n";
  ...
  while ($registro = $query->fetch()) 
  {
    ...
    echo "\"".$registro['num_latitud_pos']."\"".";";
    echo "\"".$registro['num_longitud_pos']."\"".";";
    echo "\n";
