          ...
          <table class="table table-striped table-bordered table-hover" id="info">
            ...
            <tbody> 
              ...
              <tr>
                ...
                <td class="derecha"><?php echo round($registro["txt_velocidad_pos"]/0.62137,2)?> Km/hr.  <?php //echo round($distanciarecorrida,2);?></td>
                <td class="derecha"><?php echo round($distanciarecorrida,2);?> Km.</td>
                <td><?php if($registro["num_ignicion_pos"]) echo "Encendido"; else echo "Apagado";?></td>
                <td><?php echo $registro["txt_odometro_pos"]?></td>
                <td><?php echo $registro["txt_combtot_pos"]?></td>
