<?php
  $consulta1  = "SELECT txt_economico_rem FROM tb_remolques ORDER BY txt_economico_rem ASC";  
      ...
      <div class="row">
        ...
        <div class="col-md-6 izquierda">
          ...
          <?php   
            ...
            {
          ?>
            <option value="<?php echo $registro1["txt_economico_rem"]?>"><?php echo $registro1["txt_economico_rem"]?></option> 
          <?php 
            } 
          ?>    
          </select>
