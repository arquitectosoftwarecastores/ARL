...
$( "#imprime" ).click(function() {
    ...
    var url = "index.php?seccion=alertas&accion=imprime"; 
...
$( "#pdf" ).click(function() {
    ...
    var url = "alertas/for_pdf2.php?pdf=1"; 
    // var url = "index.php?seccion=alertas&accion=pdf"; 
    <?php if(isset($_GET["busca"])) { ?>
      url=url +"&txt_busca=<?php echo $_GET['busca'];?>";
    <?php } ?>
    <?php if(isset($_GET["rxp"])) { ?>
...
$( "#excel" ).click(function() {
    ...
    var url = "alertas/for_excel.php?excel=1"; 
    <?php if(isset($_GET["busca"])) { ?>
      url=url +"&txt_busca=<?php echo $_GET['busca'];?>";
    <?php } ?>
    <?php if(isset($_GET["rxp"])) { ?>
