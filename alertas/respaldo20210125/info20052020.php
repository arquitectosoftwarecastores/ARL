...
$consultaalertas = "  select a.fec_fecha_ale as fecha, a.txt_ubicacion_ale as ubicacion, a.alerta_fecha_registro as registro, a.txt_comentarios_ale as comentarios,
                    a.fec_verifica_ale as verifica, u.txt_nombre_usu as usuario from monitoreo.tb_alertas a left join monitoreo.tb_usuarios u on a.fk_clave_usu = u.pk_clave_usu	
...
<table id="customers">
    ...
    <tbody>
        ...
        while ($registroalertas = $queryalertas->fetch()) {
            ...
            $txt_ubicacion_ale = $registroalertas["ubicacion"];
