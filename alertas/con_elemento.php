...
$strSQL = "SELECT txt_nombre_tipa,txt_economico_rem,num_estatus_ale,
        ...
        MAX(ta.txt_campo1_ale) AS txt_campo1_ale,
        MAX(ta.txt_campo2_ale) as txt_campo2_ale, 
        MAX(ta.txt_campo3_ale) AS txt_campo3_ale,
        MAX(ta.txt_campo4_ale) AS txt_campo4_ale,
        MAX(ta.txt_campo4_ale) AS txt_campo5_ale
