...
for ($i = 0; $i < sizeof($registros); $i++) {
  ...
  $consulta  = " SELECT *, date_trunc('day', fec_fecha_ale) as dia 
                FROM tb_alertas 
                WHERE pk_clave_ale=?";
...
*/
  ...
  $consulta1  = " UPDATE tb_alertas 
                  SET txt_comentarios_ale=? , num_estatus_ale=1 , fk_clave_usu=?, fec_verifica_ale = now() 
