      ...
      <div class="row renglon">
        ...
        <div class="col-md-1 centrado">
          ...
          ?>
            ...
            data-observaciones="<?php echo $registro["txt_comentarios_ale"]; ?>" data-fechahora="<?php echo $registro["fec_fecha_ale"] ?>" 
            data-economico="<?php echo $registro["txt_economico_rem"] ?>" data-tipoalerta="<?php echo $registro["txt_nombre_tipa"] ?>" 
            data-idtipoalerta="<?php echo $registro["pk_clave_tipa"] ?>" data-prioridad="<?php echo $prioridad ?>" 
            data-estatus="<?php echo $estatus . $nombre ?>" data-por="<?php echo $nombre ?>" 
            data-idG="<?php echo $registro["txt_economico_rem"] ?>" 
            data-ubicacion="<?php echo $registro["num_latitud_ale"] . "," . $registro["num_longitud_ale"] ?>">CONSULTAR</button>
