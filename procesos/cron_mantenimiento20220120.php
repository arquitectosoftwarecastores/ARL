...
date_default_timezone_set("America/Mexico_City");
    ...
    while ($registro = $query->fetch()) {
      ...
      //  $mantenimiento = checazona($latitud1, $longitud1, 2, $conn);
        ...
        echo "<br>";        
        $inserta_mantenimiento = "SELECT r.noeconomico, CONCAT (ao.fechafin,' ',ao.horafin) AS fecha, COUNT(r.noeconomico) AS total, 
        DATE_ADD(CURDATE(),INTERVAL 120 DAY) AS fechasig, now() as fechareg
        from siat.actividadorden2021 ao
        join siat.ordenservicio2021 o on o.idordenservicio = ao.idordenservicio 
        join camiones.remolques r on r.idremolque = o.unidad 
        WHERE ao.fechafin = CURDATE() and ao.idactividad = 1638 and o.idtipounidad = 4 AND r.noeconomico = ?";
