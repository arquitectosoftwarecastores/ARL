...
function UpdateSecundario($datosGPS,$conn){
    ...
    if($datosGPS->señal_estatus == 1 && $retorno == 1){
            ...
            break;
	    case 35: $query_sec = "update avl_secundario set sec_primarioupos = ? where sec_primario = ? ";
            break;
...
function VerificaSecundario($datosGPS,$conn){
    ...
    if($datosGPS->señal_estatus == 1){
        ...
        break;
	case 35: $query_sec = "select sec_primarioupos as fecha from avl_secundario where sec_primario = ?";
        break;
