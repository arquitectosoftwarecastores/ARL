...
$consultadesvio = "select count(*) as bandera from monitoreo.tb_vehiculos v join monitoreo.geocercasporunidad g on g.economico=v.txt_economico_veh where g.sucursal in (3563,3575,3576,3577,3578,3616,3653,3654) and v.txt_economico_veh = ?";
