...
$consulta = "SELECT * FROM ctg_vehiculos c join monitoreo.tb_vehiculos v on c.veh_nserie = v.num_serie_veh where v.txt_economico_veh >= '65700' and v.txt_economico_veh < '90000';";
