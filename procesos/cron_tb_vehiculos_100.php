...
$consulta = "SELECT * FROM ctg_vehiculos c join monitoreo.tb_vehiculos v on c.veh_nserie = v.num_serie_veh order by fec_posicion_veh asc limit 100";
...
$consulta_no_existe = "SELECT tv.pk_clave_veh,tv.num_serie_veh,tv.txt_odometro_veh,tv.txt_combtot_veh,tv.fec_posicion_veh,tv.txt_economico_veh FROM tb_vehiculos AS tv
				 LEFT JOIN lectura_tablero AS lt
				 ON tv.pk_clave_veh = lt.pk_clave_veh
				 WHERE lt.num_serie_veh IS NULL";
