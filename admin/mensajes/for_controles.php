<div class="container">
    <div class="row"> 
        ...
        <div class="col-md-3"><input type="text" id="busca" class="form-control" value="<?php if(isset($_GET["busca"])) echo $_GET["busca"]; ?>" placeholder="No. económico" /></div>
...
$( "#imprime" ).click(function() {
    ...
    var url = "index.php?seccion=mensajes&accion=imprime"; 
...
$( "#pdf" ).click(function() {
    ...
    var url = "admin/mensajes/for_pdf2.php?pdf=1"; 
    // var url = "index.php?seccion=mensajes&accion=pdf"; 
    <?php if(isset($_GET["busca"])) { ?>
      url=url +"&txt_busca=<?php echo $_GET['busca'];?>";
    <?php } ?>
    <?php if(isset($_GET["rxp"])) { ?>
...
$( "#excel" ).click(function() {
    ...
    var url = "admin/mensajes/for_excel.php?excel=1"; 
    <?php if(isset($_GET["busca"])) { ?>
      url=url +"&txt_busca=<?php echo $_GET['busca'];?>";
    <?php } ?>
    <?php if(isset($_GET["rxp"])) { ?>
