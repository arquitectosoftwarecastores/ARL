...
<form action="?seccion=<?php echo $seccion ?>&amp;accion=eliminaseleccionados" id="form" method="post">
    <div class="row renglon">
        ...
        <div class="col-md-1 negritas centrado"> Modulo             
        </div>
        <div class="col-md-1 negritas centrado"> Accion             
        </div>
        <div class="col-md-1 negritas centrado"> Elemento Afectado             
        </div>
    </div>  
<div class="row renglon">
    <div class="col-md-1 centrado">
        <?php
        $consulta2 = "select * from monitoreo.bitacora_usuarios b join monitoreo.tb_usuarios u on b.txt_usuario_usu = u.txt_usuario_usu 
            where b.fecha > '".$fechainicial." ".$horainicial."' and b.fecha < '".$fechafinal." ".$horafinal."'";
        ...
        <div class="row renglon">
            ...
            <div class="col-md-1 centrado"><?php echo $registro["id_modulo"] ?></div>
            <div class="col-md-1 centrado"><?php echo $registro["accion"] ?></div>
            <div class="col-md-1 centrado"><?php echo $registro["txt_modificado"] ?></div>
        </div>       
<?php } ?>
</div>      
</form>
<center>
    ...
    $consulta3 = "select count(*) as total
                 from monitoreo.bitacora_usuarios b join monitoreo.tb_usuarios u on b.txt_usuario_usu = u.txt_usuario_usu 
            where b.fecha > '".$fechainicial." ".$horainicial."' and b.fecha < '".$fechafinal." ".$horafinal."'";
