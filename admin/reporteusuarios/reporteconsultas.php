...
<form action="?seccion=<?php echo $seccion ?>&amp;accion=eliminaseleccionados" id="form" method="post">
    <div class="row renglon">
        ...
        <div class="col-md-1 negritas centrado"> Unidad             
        </div>
...
<div class="row renglon">
    <div class="col-md-1 centrado">
        <?php
        $consulta2 = "select * from monitoreo.tb_consultas c join monitoreo.tb_usuarios u on c.usuario = u.txt_usuario_usu 
                     where c.fecha > '".$fechainicial." ".$horainicial."' and c.fecha < '".$fechafinal." ".$horafinal."'";
        ...
        <div class="row renglon">
            <div class="col-md-1"><input type="checkbox" name="registros[]" value="<?php echo $registro[id_consulta] ?>"/></div>
            <div class="col-md-1"><?php echo $registro["usuario"]; ?></div>
            <div class="col-md-3"><?php echo $registro["txt_nombre_usu"]; ?></div>
            <div class="col-md-2 centrado"><?php echo $registro["fecha"] ?></div>
            <div class="col-md-1 centrado"><?php echo $registro["unidad"] ?></div>
            <div class="col-md-1 centrado"><?php echo $registro["submodulo"] ?></div>
        </div>       
<?php } ?>
</div>      
</form>
<center>
    ...
    $consulta3 = "select count(*) as total
                from monitoreo.tb_consultas c join monitoreo.tb_usuarios u on c.usuario = u.txt_usuario_usu 
                where c.fecha > '".$fechainicial." ".$horainicial."' and c.fecha < '".$fechafinal." ".$horafinal."'";
