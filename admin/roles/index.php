<?php
	//Módulo 4 = Roles
	$consulta = "select count(*) as total from monitoreo.tb_usuarios u join monitoreo.tb_modulosxrol r on u.fk_clave_rol = r.fk_clave_rol where r.fk_clave_mod = 4 and pk_clave_usu = ".$_SESSION['id'];
    ...
    if($permiso>0) 
    { 
		include_once("admin/roles/def_variables.php");
		...
		switch ($accion)
		{
			case "lista":				
					...
					include_once("admin/roles/for_elemento.php");
			...
			case "agrega":						
				...
				break;			
			case "cambia":						
				include ("admin/roles/for_cambia.php");
				break;
			case "actualiza":
				include ("admin/roles/con_actualiza.php");
				break;
			case "borra":
