<div class="container">
    <div class="row">
        ...
        <?php if (isset($_SESSION["altaybajadevehiculos"])) { if ($_SESSION['rol'] == 37) {
        ...
        ?>
        <div class="col-md-2">
            <a href="?seccion=vehiculos&amp;accion=cambiacircuito">
                <button type="button" class="btn btn-success btn-xs">CAMBIAR CIRCUITOS</button>
            </a>
        </div>
        <div class="col-md-2">
            <div class="row">
