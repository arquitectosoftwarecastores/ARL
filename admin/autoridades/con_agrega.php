<?php
  ...
  $consulta  = "INSERT INTO tb_autoridades
				(txt_nombre_aut,txt_telefono1_aut,txt_telefono2_aut,num_latitud_aut,num_longitud_aut,fk_clave_mun,fk_clave_tipa, fec_ultima_aut)
		        VALUES (?,?,?,?,?,?,?,NOW())";
