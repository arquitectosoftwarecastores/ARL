<?php
  ...
  $consulta5  = " SELECT * FROM tb_tiposdeautoridades ORDER BY pk_clave_tipa ASC ";  
    ...
    <div class="modal-content">
      ...
      <form action="?seccion=<?php echo $seccion;?>&amp;accion=agrega" id="form1" method="post">
        <fieldset>   
          ...
          <div class="row">   
            <div class="col-md-6">
                Teléfono 1:<input type="text" name="telefono1" id="telefono1" class="validate[required] text-input text form-control" size="20" maxlength="20"   />
            </div>
            <div class="col-md-6">
                Teléfono 2:<input type="text" name="telefono2" id="telefono2" class="text-input text form-control" size="20" maxlength="20"   />
            </div>
          </div>
          <div class="row">   
            <div class="col-md-6">
                Latitud:<input type="text" name="latitud" id="latitud" class="validate[required] text-input text form-control" size="30" maxlength="30"   />
            </div>
            <div class="col-md-6">
                Longitud:<input type="text" name="longitud" id="longitud" class="validate[required] text form-control" size="30" maxlength="30"   />
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="row">             
            <div class="col-md-6">
              ...
              <select name="tipo" id="tipo" class="text-input text form-control" >
                ...
                ?>
                <option value="<?php echo $registro5['pk_clave_tipa']; ?>"><?php echo $registro5['txt_nombre_tipa']; ?></option>
                <?php } ?>
              </select>
            </div>  
          </div>
