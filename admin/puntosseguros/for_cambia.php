    ...
    <div class="col-md-12">   
      <form action="?seccion=<?php echo $seccion;?>&amp;accion=actualiza" id="form1" method="post">
        <fieldset>   
          <div class="row">   
            <div class="col-md-12">
                Nombre:<input type="text" name="nombre" id="nombre" class="validate[required] text-input text form-control" size="120" maxlength="120" value="<?php echo $registro["txt_nombre_pun"]?>"  />
            </div>
          </div>
          <div class="row">   
            <div class="col-md-6">
                Latitud:<input type="text" name="latitud" id="latitud" class="validate[required] text-input text form-control" size="30" maxlength="30"  value="<?php echo $registro["num_latitud_pun"]?>" />
            </div>
            <div class="col-md-6">
                Longitud:<input type="text" name="longitud" id="longitud" class="validate[required] text form-control" size="30" maxlength="30" value="<?php echo $registro["num_longitud_pun"]?>"  />
            </div>
          </div>
          <div class="row">
              <div class="col-md-6">
          ...
          <div class="row">   
            <div class="col-md-12">
              ...
              <select id="tipo" name="tipo" class="filtro form-control">                   
                <option value="1" <?php if($registro["num_tipo_pun"]==1) echo "selected"; ?>>SEGURO</option>
                <option value="2" <?php if($registro["num_tipo_pun"]==2) echo "selected"; ?>>INTERES</option>
              </select> 
            </div>
          </div>
          <div class="row">   
