<?php 
  ...
  $id=$_GET["id"];
  $consulta  = " SELECT * FROM tb_puntosseguros
                 WHERE pk_clave_pun=?";  
...
<div class="container">
  <div class="row">    
    <div class="col-md-12">
      <h1>Ver mapa de punto seguro</h1>      
    </div> 
  </div>
  ...
  <div class="row"> 
    <div class="col-md-12">   
          <div class="row">   
            <div class="col-md-12">
                Nombre:<input type="text" name="nombre" readonly id="nombre" class="validate[required] text-input text form-control" size="120" maxlength="120" value="<?php echo $registro["txt_nombre_pun"]?>"  />
            </div>
          </div>
          <div class="row">   
            <div class="col-md-6">
                Latitud:<input type="text" name="latitud" id="latitud" readonly class="validate[required] text-input text form-control" size="30" maxlength="30"  value="<?php echo $registro["num_latitud_pun"]?>" />
            </div>
            <div class="col-md-6">
                Longitud:<input type="text" name="longitud" id="longitud" readonly class="validate[required] text form-control" size="30" maxlength="30" value="<?php echo $registro["num_longitud_pun"]?>"  />
            </div>
          </div>
          <div class="row">
              <div class="col-md-6">
...
<div id="map" ></div>
    ...
    function initMap() {
      var myLatLng = {lat: <?php echo $registro["num_latitud_pun"]?>, lng: <?php echo $registro["num_longitud_pun"]?>};
      ...
      var contentString = "<?php echo $registro["txt_nombre_pun"]?>, <?php echo $ciudad?>, <?php echo $estado?>, <?php if($registro["num_tipo_pun"]==1) echo "SEGURO"; else echo "INTERES";?>";
