...
<div class="container-fluid">  
    ...
    <div class="row renglon">
      ...
      <div class="col-md-2">
        <?php autofiltro("txt_nombre_pun","tb_puntosseguros","nombre",$conn) ?>
      </div>    
      <div class="col-md-1 centrado">
      <?php
        $consulta7  = " SELECT  pk_clave_mun, txt_nombre_mun FROM tb_municipios WHERE pk_clave_mun IN (SELECT fk_clave_mun FROM tb_puntosseguros ) ORDER BY txt_nombre_mun ASC ";  
      ...
      <div class="col-md-1"></div> 
      <div class="col-md-1 centrado">
        <select id="tipo" name="tipo" class="filtro form-control">
          <option value="0">Ver todos</option>                    
          <option value="1" <?php if($_GET["tipo"]==1) echo "selected"; ?>>SEGURO</option>
          <option value="2" <?php if($_GET["tipo"]==2) echo "selected"; ?>>INTERES</option>
        </select> 
      </div> 
    </div>
	<?php 	
	...
	?>
      ...
      <div class="col-md-2"><?php echo $registro["txt_nombre_pun"]; ?></div>
      ...
      <div class="col-md-1 centrado"><?php echo $registro["num_latitud_pun"]?></div>      
      <div class="col-md-1 centrado"><?php echo $registro["num_longitud_pun"]?></div>      
      <div class="col-md-1 centrado"><?php if($registro["num_tipo_pun"]==1) echo "SEGURO"; else echo "INTERES";?></div>      
      <div class="col-md-1 centrado">
        <a href="?seccion=puntosseguros&amp;accion=mapa&amp;id=<?php echo $registro["pk_clave_pun"]; ?>">
          <button type="button" class="btn btn-info btn-xs btn-ubicar" data-toggle="modal" data-target="#ubicar" data-lat="<?php echo $registro["num_latitud_pun"];?>" data-long="<?php echo $registro["num_longitud_pun"];?>" >UBICAR
          </button>
        </a>
      </div>      
			<div class="col-md-1 centrado">
        <a href="?seccion=puntosseguros&amp;accion=cambia&amp;id=<?php echo $registro["pk_clave_pun"]; ?>"><button type="button" class="btn btn-primary btn-xs edita" >EDITAR</button></a>
      </div>
      <div class="col-md-1 centrado">
...
<?php include("admin/puntosseguros/for_nuevo.php") ?>
