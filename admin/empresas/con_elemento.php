<?php 
	...
	$strSQL  = " SELECT * FROM tb_empresas, tb_municipios, tb_estados WHERE fk_clave_mun=pk_clave_mun AND fk_clave_edo=pk_clave_edo ";	
	if (isset($_GET["busca"]))  
		$strSQL .= " AND ".$campoMostrar." LIKE'%".$_GET["busca"]."%' ";

	if (isset($_GET["nombre"]))  
		$strSQL .= " AND txt_nombre_emp LIKE'%".$_GET["nombre"]."%' ";
