<!-- Con <page> se define una hoja con los márgenes que se muestran -->
<style type="text/css">
    <!--
...
//        if ($registro1['txt_combtot_pos'] != '')
  //          $comb_total = $registro1['txt_combtot_pos'];
            $comb_total = 0;
        if ($registro1['num_velocidad_pos'] != '')
            $velocidad = $registro1['num_velocidad_pos'];
...
<page backtop="58mm" backbottom="10mm" backleft="10mm" backright="10mm" footer="page">
    <page_header>
        ...
        <table id="datos_header">
            <tr class="tabla fila" style="width: 100%;">
                <th id="col_4" style="border-top-left-radius: 20px; width: 15%;">
                    <strong>Fecha/Hora</strong>
                </th>
                <th id="col_4" style="width: 35%;">
                    <strong>Posición</strong>
                </th>
                <th id="col_4" style="width: 5%;">
                    <strong>Dist.</strong>
                </th>
                <th id="col_4" style="width: 5%;">
                    <strong>Vel.</strong>
                </th>
                <th id="col_4" style="width: 10%;">
                    <strong>Ignición</strong>
                </th>
                <th id="col_4" style="width: 10%;">
                    <strong>Latitud</strong>
                </th>
                <th id="col_4" style="border-top-right-radius: 20px; width: 10%;">
                ...
                <tr class="tabla fila" >
                    ...
                    if (($ii == 0) or ($ii % $num == 0)) {
                        ...
                        switch ($flag_fill_color) {
                            case "No":
                                ?>
                                <td id="col_5" style="width: 15%;"><?php echo $filas['uposicion'] ?></td>
                                <td id="col_5" style="width: 40%;"><?php echo $filas['posicion'] ?></td>
                                <td id="col_5" style="width: 5%;"><?php echo $filas['distancia_recorrida'] ?> Kms.</td>
                                <!-- <td id="col_5" width="85">< <!--?php echo $filas['speed']?> Km/hr.  <<php echo $filas['distancia_recorrida']?></td>  -->
                                <td id="col_5" style="width: 5%;"><?php
                    if ($velocidad_anterior != 0) {
                      ...
                      //  echo $distancia_anterior;
                                ...
                                ?> Km/hr.</td> 
                                <td id="col_5" style="width: 10%;"><?php if ($filas['ignicion']) echo "Encendido"; else echo "Apagado"; ?></td>
                                <td id="col_5" style="width: 10%;"><?php echo $filas['latitud'] ?></td>
                                <td id="col_5" style="width: 10%;"><?php echo $filas['longitud'] ?></td>
                                <?php
                                $flag_fill_color = "Si";
                                break;
                            case "Si":
                                ?>
                                <td id="col_3" style="width: 15%;"><?php echo $filas['uposicion'] ?></td>
                                <td id="col_3" style="width: 40%;"><?php echo $filas['posicion'] ?></td>
                                <td id="col_3" style="width: 5%;"><?php echo $filas['distancia_recorrida'] ?> Kms.</td> <!-- distancia_odo -->
                              <!--    <td id="col_3" width="85"><<!--?php echo $filas['speed']?> Km/hr.  <<!--?php echo $filas['distancia_recorrida']?></td>  -->
                                <td id="col_3" style="width: 5%;"><?php
                    if ($velocidad_anterior != 0) {
                        $distancia = $filas['distancia_recorrida'] - $distancia_anterior;
                        $last_date = $filas['uposicion'];
                        $total_time = tiempototal($pos_ant, $filas['uposicion']);
                     ...
                     //   echo $distancia_anterior;
                                ...
                                ?> Km/hr.</td>
                                <td id="col_3" style="width: 10%;"><?php if ($filas['ignicion']) echo "Encendido"; else echo "Apagado"; ?></td>
                                <td id="col_3" style="width: 10%;"><?php echo $filas['latitud'] ?></td>
                                <td id="col_3" style="width: 10%;"><?php echo $filas['longitud'] ?></td>
