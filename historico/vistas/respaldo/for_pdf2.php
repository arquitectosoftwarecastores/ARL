...
<page_header>
    ...
    <table id="datos_header">
        <tr class="tabla fila">
            ...
            <td id="col_4" width="45"><strong style="font-size:9px;">Ignición</strong></td>
            <td id="col_4" width="45" style="border-top-right-radius: 20px; font-size:9px;"><strong>Latitud, Longitud</strong></td>
        </tr>
    </table>
</page_header>
    <page_footer>
