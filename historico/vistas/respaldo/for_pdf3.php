...
<page_header>
    ...
    <table id="datos_header">
        <tr class="tabla fila">
            ...
            <td id="col_4" width="75"><strong>Distancia</strong></td>
        ...
        <tr class="tabla fila" >
            ...
            ?>
                ...
                ?>
                    ...
                    <td id="col_3" width="85"><?php echo $filas['speed']?> Km/hr.</td>
                    <td id="col_3" width="75"><?php echo $filas['distancia_odo']?> Km.</td>
