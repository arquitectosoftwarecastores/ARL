...
function plotPoint(){
	if (i < markers.length ) {	
		...
		dateMessage.innerHTML=fecha_hora;
                distanceacum = distanceacum + Math.round(distance*100)/100;
		distanceMessage.innerHTML=Math.round(distance*100)/100 + " Km.";
                distanceacumMessage.innerHTML=distanceacum + " Km.";
		if (i < markers.length - 1){
            ...
            speedMessage.innerHTML = averageSpeed + " Km/h ";
                        ...
                        distanceacum = distanceacum + Math.round(my_dtotal*100)/100;
