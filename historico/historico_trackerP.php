...
<?php
    ...
    /*  Almacenamos Consulta Historico */
    $consulta5 = "INSERT INTO monitoreo.tb_consultas(usuario,fecha,modulo,unidad,submodulo) VALUES (?,now(),14,?,'HISTORICO')";
    $query5 = $conn->prepare($consulta5);
    $query5->bindParam(1, $_SESSION["usuario"]);
    $query5->bindParam(2, $id);
    $query5->execute();
    $query5->closeCursor();
?>
