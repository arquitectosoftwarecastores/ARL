...
<?php include("api_Maps.php"); ?>
<script src="workoutTracker.js" type="text/javascript"></script>

<script type="text/javascript" src="ajax_upuntos.js"></script>
<script type="text/javascript" src="historico_tracker_ventana_pdf_csv.js"></script>
...
<form id="criterios" method="post" action="historico_tracker.php?id=<?php echo $id ?>" >
<div class="container-fluid">
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <img src="images/mm_20_green.png" />Inicio 
            <img src="images/posicion.png" />Checkpoint 
            <img src="images/mm_20_red.png" />Fin 
        </div>
        <div class="col-md-3">
            Rango de fecha-hora: 
...
<div id="stats"> 
        <table class="table table-striped table-bordered table-hover">
          <tr>
            ...
            <td>
                <button onclick="javascript:descargapdf();" class="btn btn-success btn-xs" id="pdf">PDF</button>
            </td>
            <td>
