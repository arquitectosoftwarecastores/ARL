...
class Remolque {
  ...
  async generarAlerta (tipoAlerta, prioridad, tiempo, descripcion) {
    ...
    const conNuAl = `SELECT COUNT(*) AS numale  
                      ...
                      WHERE 
                        timezone('America/Mexico_City', fec_fecha_ale) > timezone('America/Mexico_City', NOW() - INTERVAL '${tiempo} MINUTE') AND 
                        fk_clave_tipa = $1 AND 
                        txt_economico_rem = $2;`;
    ...
    if (numAle === 0) {
      ...
      const inAle = `INSERT INTO tb_alertas
                      ...
                      VALUES ($1, $2, timezone('America/Mexico_City', NOW()), $3, $4, $5, $6, $7, $8, 0 ${valDesc})`;
