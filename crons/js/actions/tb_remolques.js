...
const db = require('../db');
const semaforo = require('../custom_modules/semaforo');
...
module.exports = async () => {
  do {
    ...
    dateYes = new Date();
    dateYes = dateYes.setDate(dateYes.getHours() - 24);
    ...
    console.log('-----');
    await semaforo.actualiza('tb_remolques');
    await sleep(900000);
  } while (true);
};
