...
module.exports = {
  ...
  generar: async (economico, lat, lon, geoMun, geoCas, ign, tipoAle) => {
    ...
    const conNuAl = `SELECT COUNT(*) AS numale  
                      ...
                      WHERE 
                        timezone('America/Mexico_City', fec_fecha_ale) > (timezone('America/Mexico_City' ,NOW()) - INTERVAL '30 MINUTE') AND 
                        fk_clave_tipa = $1 AND 
                        txt_economico_veh = $2;`;
    ...
    if (numAle === 0) {
      ...
      const inAle = `INSERT INTO tb_alertas 
                      ...
                      VALUES ($1, timezone('America/Mexico_City' ,NOW()), $2, $3, $4, 3, $5, $6, $7, 0)`;
      const valAle = [
        tipoAle,
        economico,
        lat,
