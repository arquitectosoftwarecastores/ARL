 ...
 */
  ...
  georeferenciaMunicipio: async (lat, lon) => {
    ...
    const conGeo = 'SELECT ' +
      ...
      'WHERE ' +
      ' num_longitud_geo >= ' + lonRango2 +
      ' AND num_longitud_geo <= ' + lonRango1 +
      ' AND num_latitud_geo >= ' + latRango2 +
      ' AND num_latitud_geo <= ' + latRango1 +
  ...
  */
  georeferenciaCastores: async (lat, lon) => {
    ...
    const conGeo = 'SELECT * FROM tb_puntosseguros ' +
      'WHERE num_tipo_pun = 2 AND ' +
      ' num_longitud_pun >=' + lonRango2 +
      ' AND num_longitud_pun <= ' + lonRango1 +
      ' AND num_latitud_pun >= ' + latRango2 +
      ' AND num_latitud_pun <= ' + latRango1 +
