...
if (isset($_GET["id"])) {
  ...
  $fecPos = $regRem['fec_posicion_rem'];
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 900px; max-width: 100%;">
          ...
          <tr>
            ...
            <td>
              ...
              if (isset($_SESSION['mantenimiento'])) {
                ...
                <?php } else { ?>
                  <a href="?seccion=mantenimiento&accion=lista&economico=<?php echo $regRem['txt_economico_rem']; ?>&estatus=0" target="_blank">
      ...
      <div class="tab-pane fade" id="nav-mensajes" role="tabpanel" aria-labelledby="nav-mensajes-tab">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            <?php
            $consulta3  = " SELECT * FROM tb_mensajesenviadossms, tb_tiposdemensajessms WHERE pk_clave_tipm=fk_clave_tipm AND txt_economico_rem=? ORDER BY fec_fecha_mene DESC LIMIT 5 ";
