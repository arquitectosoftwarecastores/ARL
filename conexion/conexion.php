...
try {
	// create a PostgreSQL database connection
	$conAVL = new PDO("pgsql:host=" . $host . ";port=5432;dbname=" . $basededatos . ";user=" . $usuario . ";password=" . $contrasena);
	$conAVL->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
} catch (PDOException $e) {
	// report error message
	echo $e->getMessage();
}
