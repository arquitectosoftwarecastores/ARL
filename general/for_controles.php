<div class="container">
    <div class="row">
        ...
        <div class="col-md-2"><input type="text" id="busca" class="form-control form-control-sm" value="<?php if (isset($_GET["busca"])) echo $_GET["busca"]; ?>" /></div>

        <div class="col-md-1"><button type="button" id="buscar" class="btn btn-primary btn-sm">BUSCAR</button></div>
        <?php
        if ($_GET["seccion"] != 'zonas') {
        ?>
            <div class="col-md-2"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#nuevo">NUEVO</button></a></div>
        <?php
        }
        ?>
    </div>
