  ...
  <div class="container-fluid">
    ...
    ?>
      <div class="row renglon">
        ...
        <div class="col-md-1 centrado"><?php echo $registro["fk_clave_cir"] ?></div>
        <div class="col-md-1 centrado"><?php echo $registro["sucursal"] ?></div>
        <div class="col-md-1 centrado"><?php if ($registro["num_seguimiento_rem"]) echo "Sí";
                                        else echo "No"; ?></div>
